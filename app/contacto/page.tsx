...
export default function ContactoPage() {
  return (
    <Section
      ...
      description="Para instalacion, prensa, alianzas o soporte inicial, podes escribirnos por correo."
    >
      <div className="surface max-w-2xl rounded-lg p-6 md:p-8">
        <p className="text-lg font-semibold text-slate-950">{site.email}</p>
