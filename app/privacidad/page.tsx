    ...
    <Section eyebrow="Legal" title="Politica de privacidad">
      <article className="surface max-w-3xl rounded-lg p-6 leading-7 text-cream/72 md:p-8">
        <p>
          ...
          encuentra en etapa beta y no implementa pagos, login ni base de datos en esta primera
          version.
        </p>
        <h2 className="mt-8 text-xl font-semibold text-cream">Datos personales</h2>
        <p className="mt-3">
          En esta etapa, Dieta Digital no requiere crear una cuenta. Si nos escribis por correo,
          usaremos ese dato solo para responder tu consulta o gestionar el acceso a la beta.
        </p>
        <h2 className="mt-8 text-xl font-semibold text-cream">Preferencias de uso</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-8 text-xl font-semibold text-cream">Cambios futuros</h2>
        <p className="mt-3">
